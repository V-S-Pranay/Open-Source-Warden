"""All system prompts for MaintainerCopilot. Never inline prompts in feature files."""

BASE_CONTEXT = """
You are MaintainerCopilot, an AI assistant powered by NVIDIA Nemotron-3-Super.
...
HELP_MESSAGE = """## 🤖 MaintainerCopilot — Available Commands
